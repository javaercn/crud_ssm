            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="empName_add_input" class="col-sm-2 control-label">emplName</label>
                        <div class="col-sm-10">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="empName_add_input" class="col-sm-2 control-label">emplName</label>
                        <div class="col-sm-10">
                            <input type="text" name="emplName" class="form-control" id="empName_add_input"
                                   placeholder="emplName">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function build_emps_table(result) {
        ...
        $.each(emps, function (index, item) {
            ...
            var empIdTd = $("<td></td>").append(item.emplId);
            var empNameTd = $("<td></td>").append(item.emplName);
            ...
            var editBtn = $("<button></button>").addClass("btn btn-primary btn-sm edit_btn")
                ...
                .append("编辑");
            editBtn.attr("edit-id", item.emplId);

            var delBtn = $("<button></button>").addClass("btn btn-danger btn-sm delete_btn")
                .append($("<span></span>").addClass("glyphicon glyphicon-trash"))
                .append("删除");
            delBtn.attr("del-id", item.emplId);
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.code == 100) {
                    ...
                    if (undefined != result.extend.errorFields.emplName) {
                        show_validate_msg("#empName_add_input", "error", result.extend.errorFields.emplName);
                    }
                }
            }
        });
    ...
    function getEmp(id) {
        $.ajax({
            ...
            success: function (result) {
                ...
                $("#empName_update_static").text(empData.emplName);
